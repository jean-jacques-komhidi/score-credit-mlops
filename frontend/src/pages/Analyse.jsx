          ...
          <div className="sticky top-24 space-y-4 max-h-[calc(100vh-120px)] overflow-y-auto">
            ...
            {!result && !loading && (
              <div className={`rounded-2xl border-2 border-dashed p-12 text-center
                ...
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4
                  ...
                  <SearchX size={32} className={isDark ? "text-zinc-600" : "text-gray-400"} />
                </div>
                <p className={`font-semibold text-base ${isDark ? "text-zinc-300" : "text-gray-600"}`}>
            ...
            {loading && (
              <div className={`rounded-2xl border p-12 text-center
                ${isDark ? "bg-zinc-900 border-zinc-800 text-zinc-300" : "bg-white border-gray-100 text-gray-500"}`}>
